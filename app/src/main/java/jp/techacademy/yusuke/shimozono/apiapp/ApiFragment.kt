...
class ApiFragment: Fragment() {
    ...
    private var page = 0
    private var isLoading = false // 「Apiでデータを読み込み中です」のフラグ。追加ページの読み込み中にこれがないと、連続して読み込んでしまうので、それの制御のため
        ...
        recyclerView.apply {
            ...
            addOnScrollListener(object :
                ...
                override fun onScrolled(
                    ...
                    dx: Int,
                    dy: Int
                ) { // dxはx軸方向の変化量(横)dyはy軸方向の変化量(縦)ここではRecyclerViewは縦方向なので、dyだけ考慮する
